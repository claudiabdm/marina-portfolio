...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const story = ([__temp, __restore] = withAsyncContext(() => ut("home", { version: "draft" }, { customParent: "http://localhost:3000" })), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=Home.9653434f.mjs.map
