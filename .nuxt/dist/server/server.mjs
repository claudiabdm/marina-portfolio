import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h as h$1, resolveComponent, defineAsyncComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, onMounted, openBlock, createBlock, resolveDynamicComponent, normalizeProps, guardReactiveProps, onErrorCaptured, useSSRContext, withCtx, createVNode, createApp } from "vue";
...
const components = {
  Feature: defineAsyncComponent(() => import("./_nuxt/Feature.b00d7622.js").then((c) => c.default || c)),
  Grid: defineAsyncComponent(() => import("./_nuxt/Grid.3756b629.js").then((c) => c.default || c)),
  Page: defineAsyncComponent(() => import("./_nuxt/Page.902a5a1d.js").then((c) => c.default || c)),
  Teaser: defineAsyncComponent(() => import("./_nuxt/Teaser.819c0ca4.js").then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/Home.9653434f.js").then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.ca56cbd0.js").then((m2) => m2.default || m2)
  },
  {
    name: "vcalong",
    path: "/vcalong",
    ...
    component: () => import("./_nuxt/vcalong.7959f87d.js").then((m2) => m2.default || m2)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.f7aff29b.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
